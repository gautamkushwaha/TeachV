    ...
    <Navbar/>
      <div className="font-poppins mx-[9.5vw]">
        ...
        <p className="-mt-[15px] capitalize text-[1.14vw]">
          ...
          contribute your time, skills, and energy to support our various
          projects and activities. Whether you're interested in event planning,
          fundraising, outreach, or administrative tasks, there's a volunteer
          opportunity that suits your interests and availability. Volunteering
          is a fantastic way to meet new people, gain valuable experience, and
